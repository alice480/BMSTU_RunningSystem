"""
Django settings for RunningSystem project.
...
SECRET_KEY = 'django-insecure-z&ujo*r&nplu@qbt(heb29wh-_-f8g(%gip^2@q$^xx!$^cbw!'
...
ROOT_URLCONF = 'RunningSystem.urls'
...
WSGI_APPLICATION = 'RunningSystem.wsgi.application'
